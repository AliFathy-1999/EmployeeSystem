...
import { EmployeeAddVacationDialogComponent } from './employee-add-vacation-dialog/employee-add-vacation-dialog.component'; // Import MatSnackBarModule
...
@NgModule({
  declarations: [
    ...
    EmployeeAddVacationDialogComponent,
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
